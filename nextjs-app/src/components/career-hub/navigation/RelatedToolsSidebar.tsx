...
const toolRelationships: Record<string, string[]> = {
  ...
  "/career-hub/tools/cost-of-living": ["pay-calculator", "commute-calculator", "childcare-calculator"],
  "/career-hub/tools/shift-planner": ["pay-calculator", "career-path", "commute-calculator"],
  "/career-hub/tools/career-path": ["skills-analyzer", "pay-calculator", "shift-planner"],
  "/career-hub/tools/skills-analyzer": ["career-path", "pay-calculator"],
  "/career-hub/tools/commute-calculator": ["pay-calculator", "cost-of-living", "shift-planner"],
  "/career-hub/tools/childcare-calculator": ["pay-calculator", "benefits-checker", "shift-planner"],
  ...
  "/career-hub/tools/cocktail-quiz": ["safety-first", "career-path", "menu-master"],
  "/career-hub/tools/safety-first": ["cocktail-quiz", "career-path", "worktalk"],
