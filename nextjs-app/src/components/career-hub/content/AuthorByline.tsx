...
export function AuthorByline({
  ...
  if (!lastUpdated && process.env.NODE_ENV === 'development') {
    console.warn(`[AuthorByline] Missing lastUpdated for contentType="${contentType}". Pass a real review date.`);
  }
  const formattedDate = lastUpdated || "2025-01-15";
...
export function ArticleMetadata({
  ...
  const schema = {
    ...
    datePublished: datePublished || "2025-01-15T00:00:00Z",
    dateModified: dateModified || "2025-01-15T00:00:00Z",
    author: {
      "@type": "Organization",
      name: authorName,
