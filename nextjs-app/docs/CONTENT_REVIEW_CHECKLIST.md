...
Single checklist to run before publishing any Career Hub content. Combines all review dimensions.

**References:** [RESEARCH_PIPELINE.md](./RESEARCH_PIPELINE.md), [BRAND.md](./BRAND.md), [PAGE_TEMPLATE_STANDARDS.md](./PAGE_TEMPLATE_STANDARDS.md), [SEO.md](./SEO.md), [CONTENT_OPTIMIZATION.md](./CONTENT_OPTIMIZATION.md)
...
| Check | Pass if |
|-------|---------|
| Source first | Every claim traced to Tier 1–4 source (BLS, IRS, DOL, state, industry, validated) |
...
| Check | Pass if |
|-------|---------|
| All claims traced | Every claim can be traced to Tier 1–4 source |
...
## Verification Queue (Financial Content)
...
See [CONTENT_OPTIMIZATION.md](./CONTENT_OPTIMIZATION.md) for full verification process.
