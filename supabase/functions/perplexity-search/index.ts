    ...
    const response = await fetch('https://api.perplexity.ai/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: 'system', 
            content: 'You are a helpful research assistant. Provide accurate, factual information with specific dates, numbers, and data points. Always cite sources when possible. Format responses clearly with headings and bullet points.'
          },
